...
export class AiRecommenderService {
  ...
  async create(tenantId: string, dto: CreateAiRecommenderDto, userId: string) {
  ...
  async findAll(tenantId: string, query: AiRecommenderQueryDto) {
  ...
  async update(tenantId: string, id: string, dto: UpdateAiRecommenderDto, userId: string) {
  ...
  async generate(tenantId: string, dto: CreateAiRecommenderDto, userId: string) {
    const result = await this.aiGateway.invoke('recommender', {
      tenantId,
      userId,
      ...dto,
    });
